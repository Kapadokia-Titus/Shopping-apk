...
import kapadokia.nyandoro.tabiangifts.util.BigDecimalUtil;
import kapadokia.nyandoro.tabiangifts.util.Prices;
...
public class CartViewModel extends BaseObservable {
    ...
    public void setCartVisible(boolean cartVisible) {
        ...
        notifyPropertyChanged(kapadokia.nyandoro.tabiangifts.BR.cartVisible);
    }

    public void setCart(List<CartItem> cart) {
        Log.d(TAG, "setCart: updating cart.");
        this.cart = cart;
        notifyPropertyChanged(kapadokia.nyandoro.tabiangifts.BR.cart);
    }
